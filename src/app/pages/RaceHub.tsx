...
import { Scan, Trophy, User, Plus } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black flex flex-col" style={{ fontFamily: 'var(--font-body)' }}>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          <div 
            className="aspect-square rounded-3xl bg-gradient-to-br from-gray-900 to-black border-2 border-gray-800 relative overflow-hidden flex items-center justify-center mb-6"
          >
            {/* Corner accents */}
            ...
            {/* Scanner reticle */}
            <div className={`w-48 h-48 border-4 border-blue-500 rounded-2xl transition-all duration-300 ${
      ...
      {/* Bottom Navigation */}
      <div className="bg-black border-t border-gray-800 p-4 flex gap-3">
        <button 
